...
{* EH 2014-09-09 moved pubIdPlugin here START *}
{* We don't want the label 'DOI:' in front of the actual doi url generated by this plugin, so it is commented out. *}
